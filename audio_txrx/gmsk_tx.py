...
class gmsk_tx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.setWindowTitle("GMSK Transmitter")
        ...
        self.tx_freq = tx_freq = 1e9
        self.samp_rate = samp_rate = 500e3
        self.gmsk_mod = gmsk_mod = (2, 0.35)
        self.cvsd_encoder = cvsd_encoder = (8, 0.5)

        ##################################################
        # Blocks
        ##################################################
        self._tx_gain_range = Range(0, 80, 1, 30, 200)
        self._tx_gain_win = RangeWidget(self._tx_gain_range, self.set_tx_gain, 'Transmitter Gain', "counter_slider", float)
        self.top_grid_layout.addWidget(self._tx_gain_win, 0, 0, 1, 1)
        for r in range(0, 1):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.vocoder_cvsd_encode_fb_0 = vocoder.cvsd_encode_fb(cvsd_encoder[0],cvsd_encoder[1])
        ...
        self.digital_gmsk_mod_0 = digital.gmsk_mod(
            samples_per_symbol=gmsk_mod[0],
            bt=gmsk_mod[1],
            verbose=False,
            log=False)
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/home/berker/Desktop/ceng513/audio_txrx/input.wav', False)
    ...
    def get_gmsk_mod(self):
        return self.gmsk_mod

    def set_gmsk_mod(self, gmsk_mod):
        self.gmsk_mod = gmsk_mod

    def get_cvsd_encoder(self):
        return self.cvsd_encoder

    def set_cvsd_encoder(self, cvsd_encoder):
        self.cvsd_encoder = cvsd_encoder
